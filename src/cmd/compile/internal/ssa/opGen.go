...
func (k BlockKind) String(psess *PackageSession) string { return psess.blockString[k] }
...
func (o Op) Asm(psess *PackageSession) obj.As          { return psess.opcodeTable[o].asm }
func (o Op) String(psess *PackageSession) string       { return psess.opcodeTable[o].name }
func (o Op) UsesScratch(psess *PackageSession) bool    { return psess.opcodeTable[o].usesScratch }
func (o Op) SymEffect(psess *PackageSession) SymEffect { return psess.opcodeTable[o].symEffect }
func (o Op) IsCall(psess *PackageSession) bool         { return psess.opcodeTable[o].call }
