...
func (pstate *PackageState) genshift(s *gc.SSAGenState, as obj.As, r0, r1, r int16, typ int64, n int64) *obj.Prog {
...
func (pstate *PackageState) genregshift(s *gc.SSAGenState, as obj.As, r0, r1, r2, r int16, typ int64) *obj.Prog {
	p := s.Prog(pstate.gc, as)
	p.From.Type = obj.TYPE_SHIFT
...
func (pstate *PackageState) ssaGenValue(s *gc.SSAGenState, v *ssa.Value) {
	...
	case ssa.OpARMMULAF, ssa.OpARMMULAD, ssa.OpARMMULSF, ssa.OpARMMULSD:
		...
		if r != r0 {
			v.Fatalf("result and addend are not in the same register: %v", v.LongString(pstate.ssa))
		}
		p := s.Prog(pstate.gc, v.Op.Asm(pstate.ssa))
		p.From.Type = obj.TYPE_REG
		p.From.Reg = r2
	...
	case ssa.OpARMSRRconst:
		pstate.genshift(s, arm.AMOVW, 0, v.Args[0].Reg(pstate.ssa), v.Reg(pstate.ssa), arm.SHIFT_RR, v.AuxInt)
	case ssa.OpARMADDshiftLL,
		...
		ssa.OpARMXORshiftLL,
		ssa.OpARMBICshiftLL:
		pstate.genshift(s, v.Op.Asm(pstate.ssa), v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), v.Reg(pstate.ssa), arm.SHIFT_LL, v.AuxInt)
	case ssa.OpARMADDSshiftLL,
		ssa.OpARMSUBSshiftLL,
		ssa.OpARMRSBSshiftLL:
		p := pstate.genshift(s, v.Op.Asm(pstate.ssa), v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), v.Reg0(pstate.ssa), arm.SHIFT_LL, v.AuxInt)
		p.Scond = arm.C_SBIT
	case ssa.OpARMADDshiftRL,
		...
		ssa.OpARMXORshiftRL,
		ssa.OpARMBICshiftRL:
		pstate.genshift(s, v.Op.Asm(pstate.ssa), v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), v.Reg(pstate.ssa), arm.SHIFT_LR, v.AuxInt)
	case ssa.OpARMADDSshiftRL,
		ssa.OpARMSUBSshiftRL,
		ssa.OpARMRSBSshiftRL:
		p := pstate.genshift(s, v.Op.Asm(pstate.ssa), v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), v.Reg0(pstate.ssa), arm.SHIFT_LR, v.AuxInt)
		p.Scond = arm.C_SBIT
	case ssa.OpARMADDshiftRA,
		...
		ssa.OpARMXORshiftRA,
		ssa.OpARMBICshiftRA:
		pstate.genshift(s, v.Op.Asm(pstate.ssa), v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), v.Reg(pstate.ssa), arm.SHIFT_AR, v.AuxInt)
	case ssa.OpARMADDSshiftRA,
		ssa.OpARMSUBSshiftRA,
		ssa.OpARMRSBSshiftRA:
		p := pstate.genshift(s, v.Op.Asm(pstate.ssa), v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), v.Reg0(pstate.ssa), arm.SHIFT_AR, v.AuxInt)
		p.Scond = arm.C_SBIT
	case ssa.OpARMXORshiftRR:
		pstate.genshift(s, v.Op.Asm(pstate.ssa), v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), v.Reg(pstate.ssa), arm.SHIFT_RR, v.AuxInt)
	case ssa.OpARMMVNshiftLL:
		pstate.genshift(s, v.Op.Asm(pstate.ssa), 0, v.Args[0].Reg(pstate.ssa), v.Reg(pstate.ssa), arm.SHIFT_LL, v.AuxInt)
	case ssa.OpARMMVNshiftRL:
		pstate.genshift(s, v.Op.Asm(pstate.ssa), 0, v.Args[0].Reg(pstate.ssa), v.Reg(pstate.ssa), arm.SHIFT_LR, v.AuxInt)
	case ssa.OpARMMVNshiftRA:
		pstate.genshift(s, v.Op.Asm(pstate.ssa), 0, v.Args[0].Reg(pstate.ssa), v.Reg(pstate.ssa), arm.SHIFT_AR, v.AuxInt)
	case ssa.OpARMMVNshiftLLreg:
		pstate.genregshift(s, v.Op.Asm(pstate.ssa), 0, v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), v.Reg(pstate.ssa), arm.SHIFT_LL)
	case ssa.OpARMMVNshiftRLreg:
		pstate.genregshift(s, v.Op.Asm(pstate.ssa), 0, v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), v.Reg(pstate.ssa), arm.SHIFT_LR)
	case ssa.OpARMMVNshiftRAreg:
		pstate.genregshift(s, v.Op.Asm(pstate.ssa), 0, v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), v.Reg(pstate.ssa), arm.SHIFT_AR)
	case ssa.OpARMADDshiftLLreg,
		...
		pstate.genregshift(s, v.Op.Asm(pstate.ssa), v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), v.Args[2].Reg(pstate.ssa), v.Reg(pstate.ssa), arm.SHIFT_LL)
	case ssa.OpARMADDSshiftLLreg,
		ssa.OpARMSUBSshiftLLreg,
		ssa.OpARMRSBSshiftLLreg:
		p := pstate.genregshift(s, v.Op.Asm(pstate.ssa), v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), v.Args[2].Reg(pstate.ssa), v.Reg0(pstate.ssa), arm.SHIFT_LL)
		p.Scond = arm.C_SBIT
	case ssa.OpARMADDshiftRLreg,
		...
		pstate.genregshift(s, v.Op.Asm(pstate.ssa), v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), v.Args[2].Reg(pstate.ssa), v.Reg(pstate.ssa), arm.SHIFT_LR)
	case ssa.OpARMADDSshiftRLreg,
		ssa.OpARMSUBSshiftRLreg,
		ssa.OpARMRSBSshiftRLreg:
		p := pstate.genregshift(s, v.Op.Asm(pstate.ssa), v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), v.Args[2].Reg(pstate.ssa), v.Reg0(pstate.ssa), arm.SHIFT_LR)
		p.Scond = arm.C_SBIT
	case ssa.OpARMADDshiftRAreg,
		...
		pstate.genregshift(s, v.Op.Asm(pstate.ssa), v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), v.Args[2].Reg(pstate.ssa), v.Reg(pstate.ssa), arm.SHIFT_AR)
	case ssa.OpARMADDSshiftRAreg,
		ssa.OpARMSUBSshiftRAreg,
		ssa.OpARMRSBSshiftRAreg:
		p := pstate.genregshift(s, v.Op.Asm(pstate.ssa), v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), v.Args[2].Reg(pstate.ssa), v.Reg0(pstate.ssa), arm.SHIFT_AR)
		p.Scond = arm.C_SBIT
	case ssa.OpARMHMUL,
		ssa.OpARMHMULU:
	...
	case ssa.OpARMMULLU:
		...
		p.Reg = v.Args[1].Reg(pstate.ssa)
		p.To.Type = obj.TYPE_REGREG
		p.To.Reg = v.Reg0(pstate.ssa)           // high 32-bit
		p.To.Offset = int64(v.Reg1(pstate.ssa)) // low 32-bit
	case ssa.OpARMMULA, ssa.OpARMMULS:
		...
		p.To.Reg = v.Reg(pstate.ssa)                   // result
		p.To.Offset = int64(v.Args[2].Reg(pstate.ssa)) // addend
	...
	case ssa.OpARMCMPshiftLL, ssa.OpARMCMNshiftLL, ssa.OpARMTSTshiftLL, ssa.OpARMTEQshiftLL:
		pstate.genshift(s, v.Op.Asm(pstate.ssa), v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), 0, arm.SHIFT_LL, v.AuxInt)
	case ssa.OpARMCMPshiftRL, ssa.OpARMCMNshiftRL, ssa.OpARMTSTshiftRL, ssa.OpARMTEQshiftRL:
		pstate.genshift(s, v.Op.Asm(pstate.ssa), v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), 0, arm.SHIFT_LR, v.AuxInt)
	case ssa.OpARMCMPshiftRA, ssa.OpARMCMNshiftRA, ssa.OpARMTSTshiftRA, ssa.OpARMTEQshiftRA:
		pstate.genshift(s, v.Op.Asm(pstate.ssa), v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), 0, arm.SHIFT_AR, v.AuxInt)
	case ssa.OpARMCMPshiftLLreg, ssa.OpARMCMNshiftLLreg, ssa.OpARMTSTshiftLLreg, ssa.OpARMTEQshiftLLreg:
		pstate.genregshift(s, v.Op.Asm(pstate.ssa), v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), v.Args[2].Reg(pstate.ssa), 0, arm.SHIFT_LL)
	case ssa.OpARMCMPshiftRLreg, ssa.OpARMCMNshiftRLreg, ssa.OpARMTSTshiftRLreg, ssa.OpARMTEQshiftRLreg:
		pstate.genregshift(s, v.Op.Asm(pstate.ssa), v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), v.Args[2].Reg(pstate.ssa), 0, arm.SHIFT_LR)
	case ssa.OpARMCMPshiftRAreg, ssa.OpARMCMNshiftRAreg, ssa.OpARMTSTshiftRAreg, ssa.OpARMTEQshiftRAreg:
		pstate.genregshift(s, v.Op.Asm(pstate.ssa), v.Args[0].Reg(pstate.ssa), v.Args[1].Reg(pstate.ssa), v.Args[2].Reg(pstate.ssa), 0, arm.SHIFT_AR)
	case ssa.OpARMMOVWaddr:
		p := s.Prog(pstate.gc, arm.AMOVW)
	...
	case ssa.OpARMMOVWloadshiftLL:
		p := pstate.genshift(s, v.Op.Asm(pstate.ssa), 0, v.Args[1].Reg(pstate.ssa), v.Reg(pstate.ssa), arm.SHIFT_LL, v.AuxInt)
		p.From.Reg = v.Args[0].Reg(pstate.ssa)
	case ssa.OpARMMOVWloadshiftRL:
		p := pstate.genshift(s, v.Op.Asm(pstate.ssa), 0, v.Args[1].Reg(pstate.ssa), v.Reg(pstate.ssa), arm.SHIFT_LR, v.AuxInt)
		p.From.Reg = v.Args[0].Reg(pstate.ssa)
	case ssa.OpARMMOVWloadshiftRA:
		p := pstate.genshift(s, v.Op.Asm(pstate.ssa), 0, v.Args[1].Reg(pstate.ssa), v.Reg(pstate.ssa), arm.SHIFT_AR, v.AuxInt)
		p.From.Reg = v.Args[0].Reg(pstate.ssa)
	...
	case ssa.OpARMMOVWstoreshiftLL:
		...
		p.To.Reg = v.Args[0].Reg(pstate.ssa)
		p.To.Offset = int64(makeshift(v.Args[1].Reg(pstate.ssa), arm.SHIFT_LL, v.AuxInt))
	case ssa.OpARMMOVWstoreshiftRL:
		...
		p.To.Type = obj.TYPE_SHIFT
		p.To.Reg = v.Args[0].Reg(pstate.ssa)
		p.To.Offset = int64(makeshift(v.Args[1].Reg(pstate.ssa), arm.SHIFT_LR, v.AuxInt))
	case ssa.OpARMMOVWstoreshiftRA:
		...
		p.To.Type = obj.TYPE_SHIFT
		p.To.Reg = v.Args[0].Reg(pstate.ssa)
		p.To.Offset = int64(makeshift(v.Args[1].Reg(pstate.ssa), arm.SHIFT_AR, v.AuxInt))
	case ssa.OpARMMOVBreg,
		...
		if a.Op == ssa.OpLoadReg {
			t := a.Type
			switch {
			case v.Op == ssa.OpARMMOVBreg && t.Size(pstate.types) == 1 && t.IsSigned(),
				v.Op == ssa.OpARMMOVBUreg && t.Size(pstate.types) == 1 && !t.IsSigned(),
				v.Op == ssa.OpARMMOVHreg && t.Size(pstate.types) == 2 && t.IsSigned(),
				v.Op == ssa.OpARMMOVHUreg && t.Size(pstate.types) == 2 && !t.IsSigned():
		...
		if pstate.objabi.GOARM >= 6 {
			...
			pstate.genshift(s, v.Op.Asm(pstate.ssa), 0, v.Args[0].Reg(pstate.ssa), v.Reg(pstate.ssa), arm.SHIFT_RR, 0)
			return
		}
		fallthrough
	case ssa.OpARMMVN,
	...
	case ssa.OpARMLoweredZero:
		...
		p.To.Reg = arm.REG_R1
		p.To.Offset = sz
		p2 := s.Prog(pstate.gc, arm.ACMP)
		p2.From.Type = obj.TYPE_REG
		p2.From.Reg = v.Args[1].Reg(pstate.ssa)
		p2.Reg = arm.REG_R1
		p3 := s.Prog(pstate.gc, arm.ABLE)
	...
	case ssa.OpARMLoweredMove:
		...
		p2.To.Offset = sz
		p3 := s.Prog(pstate.gc, arm.ACMP)
		p3.From.Type = obj.TYPE_REG
		p3.From.Reg = v.Args[2].Reg(pstate.ssa)
		p3.Reg = arm.REG_R1
		p4 := s.Prog(pstate.gc, arm.ABLE)
...
func (pstate *PackageState) ssaGenBlock(s *gc.SSAGenState, b, next *ssa.Block) {
	...
	case ssa.BlockDefer:
		...
		p := s.Prog(pstate.gc, arm.ACMP)
		p.From.Type = obj.TYPE_CONST
		p.From.Offset = 0
		p.Reg = arm.REG_R0
		p = s.Prog(pstate.gc, arm.ABNE)
		p.To.Type = obj.TYPE_BRANCH
