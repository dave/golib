...
func NewPackageState(dwarf_pstate *dwarf.PackageState, obj_pstate *obj.PackageState, src_pstate *src.PackageState, types_pstate *types.PackageState, objabi_pstate *objabi.PackageState, syntax_pstate *syntax.PackageState, bio_pstate *bio.PackageState, sys_pstate *sys.PackageState, ssa_pstate *ssa.PackageState, gcprog_pstate *gcprog.PackageState) *PackageState {
	pstate := &PackageState{}
	...
	pstate.syntax = syntax_pstate
	pstate.bio = bio_pstate
	pstate.sys = sys_pstate
	pstate.ssa = ssa_pstate
	pstate.gcprog = gcprog_pstate
	pstate.dotField = map[typeSymKey]*types.Field{}
	pstate.declImporter = map[*types.Sym]iimporterAndOffset{}
	pstate.inlineImporter = map[*types.Sym]iimporterAndOffset{}
	pstate.omit_pkgs = []string{"runtime/internal/atomic", "runtime/internal/sys", "runtime", "runtime/race", "runtime/msan", "internal/cpu"}
	pstate.norace_inst_pkgs = []string{"sync", "sync/atomic"}
	pstate.u64_f64 = u642fcvtTab{
		geq:   ssa.OpGeq64,
	...
	pstate.u32_f64 = u322fcvtTab{
		cvtI2F: ssa.OpCvt32to64F,
		cvtF2F: ssa.OpCopy,
	}
	pstate.u32_f32 = u322fcvtTab{
		cvtI2F: ssa.OpCvt32to32F,
		cvtF2F: ssa.OpCvt64Fto32F,
	}
	pstate.f32_u64 = f2uCvtTab{
		ltf:        ssa.OpLess32F,
	...
	pstate.f32_u32 = f2uCvtTab{
		ltf:        ssa.OpLess32F,
		cvt2U:      ssa.OpCvt32Fto32,
		subf:       ssa.OpSub32F,
		or:         ssa.OpOr32,
		floatValue: (*state).constFloat32,
		intValue:   func(s *state, t *types.Type, v int64) *ssa.Value { return s.constInt32(pstate, t, int32(v)) },
		cutoff:     2147483648,
	}
	pstate.f64_u32 = f2uCvtTab{
		ltf:        ssa.OpLess64F,
	...
	pstate.mapaccess1 = mkmapnames("mapaccess1", "")
	pstate.mapaccess2 = mkmapnames("mapaccess2", "")
	pstate.mapassign = mkmapnames("mapassign", "ptr")
	pstate.mapdelete = mkmapnames("mapdelete", "")
	pstate.inittemps = make(map[*Node]*Node)
	pstate.fpConvOpToSSA = map[twoTypes]twoOpsAndType{
	...
	pstate.fpConvOpToSSA32 = map[twoTypes]twoOpsAndType{
	...
	pstate.uint64fpConvOpToSSA = map[twoTypes]twoOpsAndType{
	...
	pstate.dotlist = make([]Dlist, 10)
	pstate.reservedimports = []string{
		"go",
		"type",
	}
	pstate.LivenessInvalid = LivenessIndex{-2, -2}
	pstate.allowedStdPragmas = map[string]bool{
	...
	pstate.numImport = make(map[string]int)
	pstate._Class_index = [...]uint8{0, 4, 11, 16, 25, 31, 40, 45, 53}
	pstate.basicnames = []string{
		TINT:        "int",
		TUINT:       "uint",
		TINT8:       "int8",
		TUINT8:      "uint8",
	...
	pstate.sharedProgArray = new([10000]obj.Prog)
	pstate.keepAlive = func(interface{}) {}
	pstate.importMap = map[string]string{}
	pstate.concurrentFlagOK = [256]bool{
	...
	pstate.memVar = Node{Op: ONAME, Sym: &types.Sym{Name: "mem"}}
	pstate.ptrVar = Node{Op: ONAME, Sym: &types.Sym{Name: "ptr"}}
	pstate.lenVar = Node{Op: ONAME, Sym: &types.Sym{Name: "len"}}
	pstate.newlenVar = Node{Op: ONAME, Sym: &types.Sym{Name: "newlen"}}
	pstate.capVar = Node{Op: ONAME, Sym: &types.Sym{Name: "cap"}}
	pstate.typVar = Node{Op: ONAME, Sym: &types.Sym{Name: "typ"}}
	pstate.okVar = Node{Op: ONAME, Sym: &types.Sym{Name: "ok"}}
	pstate.shiftOpToSSA = map[opAndTwoTypes]ssa.Op{
	...
	pstate.opToSSA = map[opAndType]ssa.Op{
	...
	pstate.signatset = make(map[*types.Type]struct{})
	pstate.kinds = []int{
		TINT:        objabi.KindInt,
	...
	pstate.typepkg = pstate.types.NewPkg("type", "type")
	pstate.debugtab = []struct {
		name string
		help string
		val  interface{} // must be *int or *string
	}{
		{"append", "print information about append compilation", &pstate.Debug_append},
		{"closure", "print information about closure compilation", &pstate.Debug_closure},
		{"compilelater", "compile functions as late as possible", &pstate.Debug_compilelater},
		{"disablenil", "disable nil checks", &pstate.disable_checknil},
		{"dclstack", "run internal dclstack check", &pstate.debug_dclstack},
		{"gcprog", "print dump of GC programs", &pstate.Debug_gcprog},
		{"nil", "print information about nil checks", &pstate.Debug_checknil},
		{"panic", "do not hide any compiler panic", &pstate.Debug_panic},
		{"slice", "print information about slice compilation", &pstate.Debug_slice},
		{"typeassert", "print information about type assertion inlining", &pstate.Debug_typeassert},
		{"wb", "print information about write barriers", &pstate.Debug_wb},
		{"export", "print export data", &pstate.Debug_export},
		{"pctab", "print named pc-value table", &pstate.Debug_pctab},
		{"locationlists", "print information about DWARF location list creation", &pstate.Debug_locationlist},
		{"typecheckinl", "eager typechecking of inline function bodies", &pstate.Debug_typecheckinl},
		{"dwarfinl", "print information about DWARF inlined function creation", &pstate.Debug_gendwarfinl},
		{"softfloat", "force compiler to emit soft-float code", &pstate.Debug_softfloat},
	}
	pstate.prealloc = map[*Node]*Node{}
	pstate.runtimeDecls = [...]struct {
		name string
		tag  int
		typ  int
	}{
