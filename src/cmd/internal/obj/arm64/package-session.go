...
func NewPackageSession(obj_psess *obj.PackageSession, objabi_psess *objabi.PackageSession, sys_psess *sys.PackageSession) *PackageSession {
	...
	psess.ARM64DWARFRegisters = map[int16]int16{
		REG_R0:  0,
		REG_R1:  1,
		REG_R2:  2,
		REG_R3:  3,
	...
	psess.optab = []Optab{
		...
		{AMOVH, C_REG, C_NONE, C_NONE, C_REG, 45, 4, 0, 0, 0},
		{AMOVW, C_REG, C_NONE, C_NONE, C_REG, 45, 4, 0, 0, 0},
		...
		{ASWPD, C_REG, C_NONE, C_NONE, C_ZOREG, 47, 4, 0, 0, 0},
		{ASWPD, C_REG, C_NONE, C_NONE, C_ZAUTO, 47, 4, REGSP, 0, 0},
		...
		{ASTLR, C_REG, C_NONE, C_NONE, C_ZOREG, 59, 4, 0, 0, 0},
		{ASTXR, C_REG, C_NONE, C_NONE, C_ZOREG, 59, 4, 0, 0, 0},
		{ASTLXR, C_REG, C_NONE, C_NONE, C_ZOREG, 59, 4, 0, 0, 0},
	...
	psess.Linkarm64 = obj.LinkArch{
		Arch:           psess.sys.ArchARM64,
		Init:           psess.buildop,
		Preprocess:     preprocess,
		Assemble:       psess.span7,
		Progedit:       psess.progedit,
		UnaryDst:       psess.unaryDst,
		DWARFRegisters: psess.ARM64DWARFRegisters,
	}
	return psess
}
