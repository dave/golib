...
func NewPackageState(obj_pstate *obj.PackageState, objabi_pstate *objabi.PackageState, sys_pstate *sys.PackageState) *PackageState {
	...
	pstate.S390XDWARFRegisters = map[int16]int16{}
	...
	pstate.Links390x = obj.LinkArch{
		Arch:           pstate.sys.ArchS390X,
		Init:           pstate.buildop,
		Preprocess:     preprocess,
		Assemble:       pstate.spanz,
		Progedit:       progedit,
		UnaryDst:       pstate.unaryDst,
		DWARFRegisters: pstate.S390XDWARFRegisters,
	}
