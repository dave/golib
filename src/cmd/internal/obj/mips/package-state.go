...
func NewPackageState(obj_pstate *obj.PackageState, objabi_pstate *objabi.PackageState, sys_pstate *sys.PackageState) *PackageState {
	...
	pstate.MIPSDWARFRegisters = map[int16]int16{}
	...
	pstate.Linkmips64 = obj.LinkArch{
		Arch:           pstate.sys.ArchMIPS64,
		Init:           pstate.buildop,
		Preprocess:     pstate.preprocess,
		Assemble:       pstate.span0,
		Progedit:       progedit,
		DWARFRegisters: pstate.MIPSDWARFRegisters,
	}
	pstate.Linkmips64le = obj.LinkArch{
	...
	pstate.Linkmipsle = obj.LinkArch{
