...
func NewPackageSession(obj_psess *obj.PackageSession, objabi_psess *objabi.PackageSession, sys_psess *sys.PackageSession) *PackageSession {
	...
	psess.sys = sys_psess
	psess.PPC64DWARFRegisters = map[int16]int16{}
	psess.Anames = []string{
	...
	psess.optab = []Optab{
		...
		{AVSPLT, C_SCON, C_VREG, C_NONE, C_VREG, 82, 4, 0},
		{AVSPLT, C_ADDCON, C_VREG, C_NONE, C_VREG, 82, 4, 0},
		{AVSPLTI, C_SCON, C_NONE, C_NONE, C_VREG, 82, 4, 0},
		...
		{ALXV, C_SOREG, C_NONE, C_NONE, C_VSREG, 87, 4, 0},

		{ASTXV, C_VSREG, C_NONE, C_NONE, C_SOREG, 86, 4, 0},

		{ALXS, C_SOREG, C_NONE, C_NONE, C_VSREG, 87, 4, 0},

		{ASTXS, C_VSREG, C_NONE, C_NONE, C_SOREG, 86, 4, 0},

		{ALXSI, C_SOREG, C_NONE, C_NONE, C_VSREG, 87, 4, 0},

		{ASTXSI, C_VSREG, C_NONE, C_NONE, C_SOREG, 86, 4, 0},

		{AMFVSR, C_VSREG, C_NONE, C_NONE, C_REG, 88, 4, 0},
		{AMFVSR, C_FREG, C_NONE, C_NONE, C_REG, 88, 4, 0},
		{AMFVSR, C_VREG, C_NONE, C_NONE, C_REG, 88, 4, 0},

		{AMTVSR, C_REG, C_NONE, C_NONE, C_VSREG, 88, 4, 0},
		...
		{AXXMRG, C_VSREG, C_VSREG, C_NONE, C_VSREG, 90, 4, 0},

		{AXXSPLT, C_VSREG, C_NONE, C_SCON, C_VSREG, 89, 4, 0},

		{AXXPERM, C_VSREG, C_VSREG, C_SCON, C_VSREG, 90, 4, 0},

		{AXXSI, C_VSREG, C_VSREG, C_SCON, C_VSREG, 90, 4, 0},

		{AXSCV, C_VSREG, C_NONE, C_NONE, C_VSREG, 89, 4, 0},

		{AXVCV, C_VSREG, C_NONE, C_NONE, C_VSREG, 89, 4, 0},

		{AXSCVX, C_VSREG, C_NONE, C_NONE, C_VSREG, 89, 4, 0},

		{AXSCVXP, C_VSREG, C_NONE, C_NONE, C_VSREG, 89, 4, 0},

		{AXVCVX, C_VSREG, C_NONE, C_NONE, C_VSREG, 89, 4, 0},

		{AXVCVXP, C_VSREG, C_NONE, C_NONE, C_VSREG, 89, 4, 0},
	...
	psess.Linkppc64 = obj.LinkArch{
		Arch:           psess.sys.ArchPPC64,
		Init:           psess.buildop,
		Preprocess:     preprocess,
		Assemble:       psess.span9,
		Progedit:       progedit,
		DWARFRegisters: psess.PPC64DWARFRegisters,
	}
	psess.Linkppc64le = obj.LinkArch{
